...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="<?php echo htmlspecialchars('categorias_cad_return.php');?>" method="post" class="form-floating">
        ...
        <div class="form-floating mb-3">
          <input type="text" class="form-control text-capitalize" name="categoria_descricao" id="categoria_descricao" placeholder="Informe a descrição da categoria" autofocus required>
