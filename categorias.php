  ...
  <body>
    ...
    <br>      
        <div class="d-grid gap-2 mb-3">
          <a href="categorias_cad.php" class="btn btn-dark btn-lg" type="button"><small>NOVA CATEGORIA</small></a>
        </div>
          ...
          <?php
            ...
            if ($result->num_rows > 0) {
              ...
              while($row = $result->fetch_assoc()){
                ?>
                  <a href="<?php echo 'categorias_edit.php?id='.$row['categoria_id']; ?>" class="list-group-item list-group-item-action">
                    <div class="col">
                      <small class="text-muted"><?php echo $row['categoria_descricao']; ?></small>
                    </div>
                  </a>
                <?php
              }
