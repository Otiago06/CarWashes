      ...
      <!--<div class="container">
          ...
          if ($result_servicos->num_rows > 0) {
            ...
            while($row = $result_servicos->fetch_assoc()){
              ?>
                <div class="form-check">
                  <input class="form-check-input h3" name='checkboxvar[]' type="checkbox" value="<?php echo $row['servico_id']; ?>" id="flexCheckDefault<?php echo $row['servico_id'] ?>">
                  <label class="form-check-label h2" for="flexCheckDefault<?php echo $row['servico_id'] ?>">
            ...
            ?>
              <div class="text-center">
                <div class="col">
                  <small class="text-muted">Nenhum serviço foi cadastrado!</small>
                </div>
              </div>
            <?php
          }
        ...
        <!--<ul class="list-group list-group-flush">
          <li class="list-group-item">
            <div class="col">
              <small class="text-muted">Lavagem detalhada</small>
            </div>
          ...
          <li class="list-group-item">
            <div class="col">
              <small class="text-muted">Revitalização de farol (par)</small>
            </div>
            <div class="col text-end">
              <small class="text-muted">R$ 100.00</small>
            </div>
          ...
          <li class="list-group-item">
            <div class="col">
              <small class="text-muted">Polimento com revestimento cerâmico</small>
            </div>
            <div class="col text-end">
              <small class="text-muted">R$ 800.00</small>
            </div>
          </li>
        </ul>
        <hr>
        <div class="row mb-3">
          <div class="col"><small class="text-muted"><strong>Total do(s) serviço(s):</strong></small></div>
          <div class="col text-end"><small class="text-muted"><strong>R$ 1000.00</strong></small></div>
        </div>        
        <div class="d-grid gap-2 mb-3">
          <button class="btn btn-dark btn-lg" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"><small>SELECIONAR SERVIÇO(S)</small></button>
        </div>-->
      <hr><small class="text-muted">&nbsp;Dados de contato</small>
        <div class="row">
          <div class="col">
            <div class="form-floating mb-3">
